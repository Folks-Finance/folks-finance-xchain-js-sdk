export const OracleManagerAbi = [
  {
    inputs: [
      ...
      { internalType: "address", name: "nodeManager", type: "address" },
    ],
  ...
  {
    inputs: [{ internalType: "address", name: "nodeManager", type: "address" }],
    name: "InvalidNodeManager",
    type: "error",
  },
  {
    inputs: [{ internalType: "uint8", name: "poolId", type: "uint8" }],
    name: "NoNodeIdForPool",
    type: "error",
  },
  {
    inputs: [
