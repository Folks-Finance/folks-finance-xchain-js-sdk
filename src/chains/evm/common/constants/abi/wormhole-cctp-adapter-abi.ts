export const WormholeCCTPAdapterAbi = [
  {
    inputs: [
      ...
      { internalType: "address", name: "_circleToken", type: "address" },
      { internalType: "uint32", name: "_cctpSourceDomainId", type: "uint32" },
    ],
  ...
  },
  {
    ...
    name: "CircleTransmitterMintFail",
    type: "error",
  },
  { inputs: [], name: "EmptyExtraArgs", type: "error" },
  { inputs: [], name: "InvalidAdditionalMessagesLength", type: "error" },
  {
  ...
  },
  {
    ...
    name: "InvalidCCTPNonce",
    type: "error",
  },
  {
    inputs: [{ internalType: "uint32", name: "sourceDomain", type: "uint32" }],
    name: "InvalidCCTPSourceDomain",
    type: "error",
  },
  ...
  },
  {
    inputs: [
      ...
      { internalType: "uint32", name: "cctpDomainId", type: "uint32" },
