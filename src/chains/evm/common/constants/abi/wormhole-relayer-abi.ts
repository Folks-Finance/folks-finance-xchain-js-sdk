export const IWormholeRelayerAbi = [
  {
    anonymous: false,
    inputs: [
      {
  ...
  },
  {
    inputs: [
      { internalType: "uint16", name: "targetChain", type: "uint16" },
      { internalType: "uint256", name: "currentChainAmount", type: "uint256" },
      {
        internalType: "address",
        name: "deliveryProviderAddress",
        type: "address",
    ...
    outputs: [{ internalType: "uint256", name: "targetChainAmount", type: "uint256" }],
    stateMutability: "view",
    type: "function",
  },
  {
