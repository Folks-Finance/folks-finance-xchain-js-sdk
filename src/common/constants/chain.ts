    ...
    [FOLKS_CHAIN_ID.AVALANCHE_FUJI]: {
      ...
      tokens: {
        [FolksTokenId.USDC]: {
          ...
          poolId: 128,
          spokeAddress: "0xC8ad4B23B4F07A27CDDAB1A8AE2Da54377f87426",
        ...
        [FolksTokenId.AVAX]: {
          ...
          poolId: 129,
          spokeAddress: "0xF18F75595bA066efAdf4b24C7F263ba878C6B6f3",
          tokenAddress: null,
          tokenDecimals: 18,
        },
      },
    ...
    [FOLKS_CHAIN_ID.ETHEREUM_SEPOLIA]: {
      ...
      tokens: {
        [FolksTokenId.USDC]: {
          ...
          folksTokenId: FolksTokenId.USDC,
          poolId: 128,
          spokeAddress: "0x71EEc2B912a3Cef6Bf134899D437Ba17Fc9588D2",
        ...
        [FolksTokenId.ETH_eth_sep]: {
          ...
          poolId: 131,
          spokeAddress: "0xD3743aBf2D83725c06b12EC2C97c6b9dAC0D8a6F",
          tokenAddress: null,
          tokenDecimals: 18,
        },
        [FolksTokenId.LINK_eth_sep]: {
          ...
          poolId: 133,
          spokeAddress: "0xF85227ba19CC14e1b3FdcF9B2EBE199d64BE4CE9",
    ...
    [FOLKS_CHAIN_ID.BASE_SEPOLIA]: {
      ...
      tokens: {
        [FolksTokenId.USDC]: {
          ...
          folksTokenId: FolksTokenId.USDC,
          poolId: 128,
          spokeAddress: "0x6789da551F420bfb607Fffb43bf8936f9dfb7d4C",
        ...
        [FolksTokenId.ETH_base_sep]: {
          ...
          poolId: 132,
          spokeAddress: "0x457f30Bc85E885e4D519975C1dd87F397d4817B7",
          tokenAddress: null,
          tokenDecimals: 18,
        },
      },
